...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void savePet() {
        ...
        *******************************************/
        ...
        /******************** NEW *************************/
        /*
            We can call the ContentResolver insert() method with the pet content URI and a ContentValues
            object constructed from the user input fields. One major difference between the SQLiteDatabase
            insert() method and the ContentResolver insert() method is that one returns a row ID, while
            the other returns a Uri, respectively.
        */
     ...
     */
    @Override
    public void onBackPressed() { //################ same as case android.R.id.home: ###################
