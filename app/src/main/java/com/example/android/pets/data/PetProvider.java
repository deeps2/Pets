...
public class PetProvider extends ContentProvider {
     ...
     * The purpose of this method is to return a String that describes the type of the data stored
     * at the input Uri. This String is known as the MIME type, which can also be referred to as content type.
     */
    /*
    Define Custom Pet MIME types
        In our app we have essentially two types of URIs. The first is the URI is “content://com.example.android.pets/pets/”,
        which references the entire pets table. Basically it represents a list of pets. In MIME type terms, this is known as
        a directory of data. The second URI is “content://com.example.android.pets/pets/#”, which represents a single pet.
